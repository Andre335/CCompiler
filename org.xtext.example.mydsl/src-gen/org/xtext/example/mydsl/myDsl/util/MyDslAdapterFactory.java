...
public class MyDslAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected MyDslSwitch<Adapter> modelSwitch =
    new MyDslSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseValAssignment(ValAssignment object)
      {
        return createValAssignmentAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.example.mydsl.myDsl.ValAssignment <em>Val Assignment</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createValAssignmentAdapter()
  {
    return null;
  }
